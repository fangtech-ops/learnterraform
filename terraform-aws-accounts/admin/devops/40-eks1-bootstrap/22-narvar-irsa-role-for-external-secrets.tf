...
locals {
  service_account_namespace_external-secrets = "narvar-system"          # Must match https://github.com/narvar/flux-infra/blob/ce8f8ff026e08344df3bf3102a3c4707f949f3ea/resources/flux-helm-releases/external-secrets/kustomization.yaml#L7
  service_account_name_external-secrets      = "external-secrets-chart" # Must match https://github.com/narvar/flux-infra/blob/ce8f8ff026e08344df3bf3102a3c4707f949f3ea/resources/flux-helm-releases/external-secrets/helmrelease.yaml#L38
}
