...
variable "trusted_role_arns" {
  ...
  default = [
    ...
    "arn:aws:iam::472882997329:user/karl.haslinger@narvar.com",
    "arn:aws:iam::472882997329:user/sander.wang@narvar.com",
    "arn:aws:iam::472882997329:user/Charles.Lee@narvar.com",
  ]
}
